...
%\includeonly{content/systeme3}											% while writing your book, compile only what you need
...
\include{content/dgl1}
\include{content/dgl2}
\include{content/dgl3}
\include{content/laplace}
\include{content/metrik}
\include{content/picard}
\include{content/fort}
\include{content/systeme}
\include{content/hoeher}
\include{content/reihe}
\include{content/systeme2}
\include{content/systeme3}
